        ...
        function initMap() {
            const layerObj = {
                ...
                "value": {
                    ...
                    "nodeIndex": 10,
                    "subNodeIndex": 0,
                    "id": "node10_subNode0_nestedSubNodeundefined"
                }
            }
            const obj = {
                "title": "地籍圖",
                ...
                "figure_type": "Surface",
                "single_tiles": true,
                "tiles_url": "https://landmaps.nlsc.gov.tw/S_Maps/wmts/DMAPS/default/EPSG:3857/{TileMatrix}/{TileRow}/{TileCol}",
