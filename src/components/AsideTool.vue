...
<template>
  <div class="d-flex flex-nowrap flex-column">
    ...
    <div
        class="switchControl d-block d-sm-none rounded-4 p-2 mb-2"
        id="switchControl"
        style="z-index: 99"
    >
      <div
    ...
    <a
        href="#"
        class="d-none d-sm-block order-1 mb-0"
        @click.prevent="onMapControl('In')"
    >
      <img src="@/assets/img/icon/zoomIn.svg" alt="zoomIn"/>
    </a>
    <a
        href="#"
        class="d-none d-sm-block order-1 mb-2"
        @click.prevent="onMapControl('Out')"
    >
